...
/**
 * check_elf - See if a file is an ELF or not
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 * Description: exit code 98 if the file isn't ELF
 */
void check_elf(unsigned char *e_ident)
{
int index;
...
/**
 * print_magic - print the magic numers of an ELF file
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 * Description: seperate magic numbers with spaces
 */
void print_magic(unsigned char *e_ident)
{
int index;
